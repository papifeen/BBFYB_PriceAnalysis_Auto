...
public class timminsTest extends base {
    ...
    static String xlsLocation = "/Users/selenium/OneDrive/Price Analysis Files/Cannabis Jacks/TimminsPriceAuto.xlsx";
...
//            utility.getProductAndPrice(xlsLocation,"https://bestbangforyourexbud.com/store/roll-n-rock-cannabis-co-timmins", "ROCK N ROLL (993 Riverside Dr , Timmins)");
//            utility.makeEmptyColumn(xlsLocation);
