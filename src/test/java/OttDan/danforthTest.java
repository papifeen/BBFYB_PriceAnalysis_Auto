...
public class danforthTest extends base {
    ...
    static String xlsLocation = "/Users/selenium/OneDrive/Price Analysis Files/NHelm price comp analysis/DanforthPriceAnalysis.xlsx";
...
//            //Mota Toke (249 Greenwood Ave , Toronto)
//            utility.getProductAndPrice(xlsLocation,"https://bestbangforyourbud.com/store/mota-toke", "MOTA TOKE (249 Greenwood Ave , Toronto)");
//            utility.makeEmptyColumn(xlsLocation);
//
//            //AlphaBud Cannabis Company ( 1186 Woodbine Ave, Toronto )
//            utility.getProductAndPrice(xlsLocation,"https://bestbangforyourbud.com/store/east-york", "ALPHABUD CANNABIS (1186 Woodbine Ave, Toronto)");
//            utility.makeEmptyColumn(xlsLocation);
//
...
//            utility.makeEmptyColumn(xlsLocation);
//
//            //Mexicannabis ( 73 Coxwell Ave, Toronto )
//            utility.getProductAndPrice(xlsLocation,"https://bestbangforyourbud.com/store/mexicannabis", "MEXICANNABIS (73 Coxwell Ave, Toronto)");
//            utility.makeEmptyColumn(xlsLocation);
